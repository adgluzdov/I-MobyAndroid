...
public class ShowcasePresenter implements Presenter, ViewListener {
    ...
    private Action1<? super Repo> onSpecialOffersLoaded() {
        return new Action1<Repo>() {
            ...
            public void call(Repo repo) {
                ...
                SpecialOffersAdapter specialOffersAdapter = getAdapter(repo.getResponse().getSpecialOffers());
    ...
    private SpecialOffersAdapter getAdapter(List<SpecialOffer> specialOffers) {
        return new SpecialOffersAdapter(viewManager,specialOffers);
    }
}
